      ...
      <div style={styles.tokenList}>
        {tokens.map((t, i) => (
          <div key={i} style={styles.tokenItem}>
            ...
            <span style={styles.tokenMasked}>{t.token.substring(0, 8)}...</span>
          </div>
        ))}
      </div>
...
const styles = {
  ...
  logoPlaceholder: {
    ...
    justifyContent: 'center', fontSize: '20px', fontWeight: '700', color: '#3C3489',
  },
  logoInfo: { flex: 1 },
  ...
  input: {
    ...
    border: '1.5px solid #e0e0e0', fontSize: '14px', outline: 'none', boxSizing: 'border-box',
  },
  ...
  tokenBox: {
    background: '#f0fff4', borderRadius: '10px', padding: '16px', marginBottom: '16px',
  },
  ...
  tokenItemLabel: { fontWeight: '500', color: '#1a1a1a' },
