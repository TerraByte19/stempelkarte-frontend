...
export default function Scanner() {
  ...
  return (
      <div>
        ...
        <div id="qr-reader" onClick={fokusAntippen} title="Zum Scharfstellen tippen" style={{ display: cameraActive ? 'block' : 'none', width: '100%', borderRadius: '16px', overflow: 'hidden', marginBottom: '8px', cursor: 'pointer' }} />
